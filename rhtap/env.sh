...
export GITOPS_REPO_URL=https://github.com/rhtap-test-organization-jk/node-jenkins-1211-gitops
...
export REKOR_HOST=https://rekor-server-rhtap-tas.apps.rosa.qo46s-2t6ok-r6c.3wl0.p3.openshiftapps.com
...
export TUF_MIRROR=https://tuf-rhtap-tas.apps.rosa.qo46s-2t6ok-r6c.3wl0.p3.openshiftapps.com
